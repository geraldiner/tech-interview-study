# Tech Interview Study Guide

This is a truncated list based on [jwasham's coding interview university](https://github.com/jwasham/coding-interview-university) with some of my own resources sprinkled in. I took the parts that are the most related to my path to becoming a software engineer, namely the interview prep and coding exercises that could be translated to JavaScript. I don't have a lot of interest in learning Java or any of the C languages at this time. And while I am interested in Python, my focus is still JavaScript. 

At this time, I've decided to also leave my job to commit to the preparation full time. As someone who heard from someone who once said: "Sometimes you have to take a step back if that means it helps you leap forward to the next best thing."

Or something like that. So here's to leaping.

# Following Along

If you stumble upon this and decide you want to follow along, that's super cool of you! If you need an accountability buddy, send me a DM and let's be friends! 
